...
This repository contains the hands-on lab exercises for Microsoft course **Build an AI App with Azure DocumentDB (with MongoDB compatibility)**. The exercises are designed to accompany the learning materials and enable you to practice using the technologies they describe.
