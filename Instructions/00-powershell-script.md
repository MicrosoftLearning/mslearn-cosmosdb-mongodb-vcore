...
The script accepts several parameters to customize the deployment process. The following table lists details each parameter, including their default values when not explicitly provided:
